...
import { eumPerformaceMode } from '../../doc/IPCModels'
	...
	<div class="EventLoop">
		...
		<a-row justify="center">
			<a-col :span="16" style="margin-bottom: 20px">
				<a-typography-title class="title"> EvnetLoop </a-typography-title>
			</a-col>
			<div ref="STC" class="STC"></div>
			<div ref="LTC" class="LTC"></div>
			<div ref="TFS" class="TFS"></div>
			<a-col :span="16" class="item">
				<a-button v-if="!store.state.EventLoopPage.isRun" type="primary" @click="handleClick"
					>启动</a-button
				>
				<a-button v-else type="primary" @click="removeLoop">停止</a-button>
			</a-col>
			<a-col :span="16" class="item">
				<a-button
					style="margin: 5px"
					type="primary"
					@click="importConfigVisible = !importConfigVisible"
					>导入配置
				</a-button>
