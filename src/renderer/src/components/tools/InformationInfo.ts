...
const CpuTemperatureInfo = {
  ...
  data:[{
    CpuTemperature: index.state.OS.CPU.temperature,
    CPUFanSpeed: index.state.OS.CPU.CPUFanSpeed
  }]
}
const GpuTemperatureInfo = {
  ...
  data:[{
    GpuTemperature: index.state.OS.GPU.temperature,
    GPUFanSpeed: index.state.OS.GPU.GPUFanSpeed
  }]
}
  ...
  data: [
    {
      ...
      GpuUsage: index.state.OS.GPU.GpuUsage,
      GpuMode: index.state.OS.GPU.GpuMode ? "DiscreteMode" : "HybridMode"
    }
  ]
}
...
const OSInfo = {
  columns:[
   ...
   data:[
    {
      KeyboardMode: index.state.OS.KeyboardMode,
      AcType:index.state.OS.AcType
    }
  ]
}
